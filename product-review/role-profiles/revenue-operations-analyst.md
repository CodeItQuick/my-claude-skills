...
- **The unit is already metered by the existing billing pipeline.** If the scope already wires the counter into the meter, the substrate is complete.
